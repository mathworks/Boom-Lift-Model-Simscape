function [tVec, oVec] = sm_boom_lift_crawler_vseq_jib
...
t.sky.c4.rwd.go = t.sky.c4.fwd.stop + 3; 
t.sky.c4.rwd.stop = t.sky.c4.rwd.go + 9.75; % was 9.5
tVec.sky.c4.rwd = [t.sky.c4.rwd.go (t.sky.c4.rwd.go+1) t.sky.c4.rwd.stop t.sky.c4.rwd.stop+3];
oVec.sky.c4.rwd = [o.stop o.rwd o.stop o.stop];
...
tVec.sky.c3.rwd = [tVec.sky.c4.rwd(end)];
oVec.sky.c3.rwd = [o.stop];

%8. Select stick boom tilt valve
tVec.sky.c2.rwd = [tVec.sky.c4.rwd(end)];
