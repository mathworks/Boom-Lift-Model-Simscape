function [tVec, oVec] = sm_boom_lift_crawler_vseq_basketr
...
tVec.sky.r2.rwd = [t.sky.r2.rwd.go (t.sky.r2.rwd.go+1) t.sky.r2.rwd.stop t.sky.r2.rwd.stop+5];
oVec.sky.r2.rwd = [o.stop o.rwd o.stop o.stop];

% 11. Select stick boom extend valve
tVec.sky.c3.rwd = [tVec.sky.r2.rwd(end)];
oVec.sky.c3.rwd = [o.stop];

% 8. Select stick boom tilt valve
tVec.sky.c2.rwd = [tVec.sky.r2.rwd(end)];
oVec.sky.c2.rwd = [o.stop];

% 9. Select turret valve
tVec.sky.r1.rwd = [tVec.sky.r2.rwd(end)];
oVec.sky.r1.rwd = [o.stop];

% 10. Select knuckle boom lift valve
tVec.sky.c1.rwd = [tVec.sky.r2.rwd(end)];
oVec.sky.c1.rwd = [o.stop];

% 12. Select jib extend valve
tVec.sky.c4.rwd = [tVec.sky.r2.rwd(end)];
...
tVec.ground.c5.rwd = [tVec.sky.r2.rwd(end)];
oVec.ground.c5.rwd = [o.stop];

% 2. Select outrigger extend valve
tVec.ground.c1.rwd = [tVec.sky.r2.rwd(end)];
...
tVec.deviators.ground = [
    tVec.deviators.ground,...
    (t.sky.r2.fwd.go-1) tVec.sky.r2.rwd(end)];
