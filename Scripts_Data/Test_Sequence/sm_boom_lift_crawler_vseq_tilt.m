function [tVec, oVec] = sm_boom_lift_crawler_vseq_tilt
...
t.sky.c2.rwd.go = t.sky.c2.fwd.stop + 1;
t.sky.c2.rwd.stop = t.sky.c2.rwd.go + 33;  % was 37
tVec.sky.c2.rwd = [t.sky.c2.rwd.go (t.sky.c2.rwd.go+1) t.sky.c2.rwd.stop t.sky.c2.rwd.stop+2];
oVec.sky.c2.rwd = [o.stop o.rwd o.stop o.stop];

% 11. Select stick boom extend valve
tVec.sky.c3.rwd = [tVec.sky.c2.rwd(end)];
oVec.sky.c3.rwd = [o.stop];

% 12. Select jib extend valve
tVec.sky.c4.rwd = [tVec.sky.c2.rwd(end)];
oVec.sky.c4.rwd = [o.stop];

% 7. Select turret valve
tVec.sky.r2.rwd = [tVec.sky.c2.rwd(end)];
oVec.sky.r2.rwd = [o.stop];

% 9. Select slew drive valve
tVec.sky.r1.rwd = [tVec.sky.c2.rwd(end)];
oVec.sky.r1.rwd = [o.stop];

% 10. Select knuckle boom lift valve
tVec.sky.c1.rwd = [tVec.sky.c2.rwd(end)];
...
tVec.ground.c5.rwd = [tVec.sky.c2.rwd(end)];
oVec.ground.c5.rwd = [o.stop];

% 2. Select outrigger extend valve
tVec.ground.c1.rwd = [tVec.sky.c2.rwd(end)];
