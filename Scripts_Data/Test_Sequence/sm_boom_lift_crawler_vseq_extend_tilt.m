function [tVec, oVec] = sm_boom_lift_crawler_vseq_extend_tilt
...
t.sky.c3.rwd.go = tVec.sky.c3.fwd(end) + 20; % Time for jib and basketR
t.sky.c3.rwd.stop = t.sky.c3.rwd.go + 25.8; % was 25
tVec.sky.c3.rwd = [t.sky.c3.rwd.go (t.sky.c3.rwd.go+1) t.sky.c3.rwd.stop t.sky.c3.rwd.stop+2];
oVec.sky.c3.rwd = [o.stop o.rwd o.stop o.stop];
...
t.sky.c4.rwd.go = t.sky.c2.rwd.stop + 1; 
...
tVec.sky.r2.rwd = [tVec.sky.c4.rwd(end)];
oVec.sky.r2.rwd = [o.stop];

% 9. Select slew drive valve
tVec.sky.r1.rwd = [tVec.sky.c4.rwd(end)];
oVec.sky.r1.rwd = [o.stop];

% 10. Select knuckle boom lift valve
tVec.sky.c1.rwd = [tVec.sky.c4.rwd(end)];
...
tVec.ground.c5.rwd = [tVec.sky.c4.rwd(end)];
oVec.ground.c5.rwd = [o.stop];

% 2. Select outrigger extend valve
tVec.ground.c1.rwd = [tVec.sky.c4.rwd(end)];
...
tVec.deviators.ground = [
    tVec.deviators.ground,...
    t.sky.c3.fwd.stop,...
    t.sky.c3.rwd.go tVec.sky.c4.rwd(end)];
