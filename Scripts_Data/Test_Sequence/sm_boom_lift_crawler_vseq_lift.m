function [tVec, oVec] = sm_boom_lift_crawler_vseq_lift
...
t.sky.c1.fwd.go = t.start + 2;  % was 1
...
t.sky.c1.rwd.go = t.sky.c1.fwd.stop + 1; 
t.sky.c1.rwd.stop = t.sky.c1.rwd.go + 52; % was 50
tVec.sky.c1.rwd = [t.sky.c1.rwd.go (t.sky.c1.rwd.go+1) t.sky.c1.rwd.stop t.sky.c1.rwd.stop+2];
oVec.sky.c1.rwd = [o.stop o.rwd o.stop o.stop];

% 7. Select basketR valve
tVec.sky.r2.rwd = [t.sky.c1.rwd.stop(end)];
oVec.sky.r2.rwd = [o.stop];

% 11. Select stick boom extend valve
tVec.sky.c3.rwd = [t.sky.c1.rwd.stop(end)];
oVec.sky.c3.rwd = [o.stop];

%8. Select stick boom tilt valve
tVec.sky.c2.rwd = [t.sky.c1.rwd.stop(end)];
oVec.sky.c2.rwd = [o.stop];

% 9. Select turret valve
tVec.sky.r1.rwd = [t.sky.c1.rwd.stop(end)];
oVec.sky.r1.rwd = [o.stop];

% 12. Select jib extend valve
tVec.sky.c4.rwd = [t.sky.c1.rwd.stop(end)];
...
tVec.ground.c5.rwd = [t.sky.c1.rwd.stop(end)];
oVec.ground.c5.rwd = [o.stop];

% 2. Select outrigger extend valve
tVec.ground.c1.rwd = [t.sky.c1.rwd.stop(end)];
