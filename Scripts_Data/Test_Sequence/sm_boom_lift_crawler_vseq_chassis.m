function [tVec, oVec] = sm_boom_lift_crawler_vseq_chassis
...
tVec.deviators.sky = [t.start t.ground.c1.fwd.go t.ground.c5.fwd.stop+0.5];
...
tVec.ground.proportional = [t.start t.ground.c1.fwd.go (t.ground.c5.fwd.stop-1.5) t.ground.c5.fwd.stop];
...
tVec.ground.c1.all = [tVec.ground.c1.fwd tVec.ground.c1.rwd tVec.ground.c1.rwd(end)+5];
oVec.ground.c1.all = [oVec.ground.c1.fwd oVec.ground.c1.rwd o.stop];

tVec.ground.c5.all = [tVec.ground.c5.fwd tVec.ground.c5.rwd tVec.ground.c1.rwd(end)+5];
...
tVec.ground.proportional = [
    ...
    t.ground.c1.rwd.go t.ground.c1.rwd.stop-0.5];
