...
%
% This example models a hydraulic system that keeps a boom lift basket
% level as the boom tilts up and down. In this harness, the tilt actuator
% is actuated as part of the hydraulic system. Two double-acting hydraulic
% cylinders are connected in a closed circuit in a master-slave
% arrangement.
%
...
%% Model
% <matlab:sm_boom_lift_crawler_harness_open('basket%20level%20tilt%20hydr'); Open Model>

sm_boom_lift_crawler_harness_open('basket level tilt hydr')
...
% level as the boom.  A double-sided cylinder (Cylinder Slave) with two
% counterbalance valves extends to tilt the crew basket. Another
% double-sided cylinder (Cylinder Master), also with two counterbalance
% valves, contracts/extends as the boom tilts. It is connected in a closed
% hydraulic circuit with the slave cylinder and forces the slave
% to extend/contract to offset the tilt from the boom.
%
